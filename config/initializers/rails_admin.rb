# RailsAdmin config file. Generated on May 27, 2013 15:08
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Privatesyncnet', 'Admin']
  ...
  # config.excluded_models = ['Role', 'ShareItem', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Role', 'ShareItem', 'User']
  ...
  # config.model 'ShareItem' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your share_item.rb model definition
  ...
  #     configure :share_items, :has_many_association 
